...
router.get('/subjects',
 //    [validateJWT], 
     subjects_controller.subjectsGet);

router.get('/subjects/:id', 
   // [validateJWT],
     subjects_controller.subjectGetById);

router.post('/subjects',
   //  [validateJWT, esProfe],
      subjects_controller.subjectCreate);

router.put('/subjects/:id',
   //  [validateJWT, esProfe],
      subjects_controller.subjectUpdate);

router.delete('/subjects/:id',
    // [validateJWT, esProfe],
      subjects_controller.subjectDelete);
